...
@interface JobTableViewController ()<UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate, SelectBarProtocol>
...
- (void)viewDidLoad {
    ...
    searchView.frame = CGRectMake(0, 0, screenFrame.size.width, 25);
    self.searchBar.frame = CGRectMake(0, 0, searchView.bounds.size.width-15, 25);
...
//    [self.jobTableView addGestureRecognizer:singleFingerTap];
}

- (void)commentsTextViewDismissKeyboard {
    [self.selectTableViewVc.tableView setHidden:YES];
}
...
- (void)loadNewJobs
{
    ...
    [self.jobsArry addObjectsFromArray: [StuHomeLocalJob jobsWithCityId:globalCityId  AreaId:areaId TypeId:typeId CurrentPage:[NSString stringWithFormat:@"%d", self.currentPage] PageSize:[NSString stringWithFormat:@"%d", pageSize] Period:period Lng:nil Lat:nil Radius:nil Cond:@"name" Value:self.searchBar.text JobStatus:@"ongoing"]];
...
- (void)loadMoreJobs
{
    ...
    NSArray *array = [StuHomeLocalJob jobsWithCityId:globalCityId  AreaId:areaId TypeId:typeId CurrentPage:[NSString stringWithFormat:@"%d", self.currentPage] PageSize:[NSString stringWithFormat:@"%d", pageSize] Period:period Lng:nil Lat:nil Radius:nil Cond:@"name" Value:self.searchBar.text JobStatus:@"ongoing"];
    
    [self.jobsArry addObjectsFromArray: array];
