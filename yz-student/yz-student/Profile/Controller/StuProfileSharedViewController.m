//
//  StuProfileSharedViewController.m
//  yz-student
//
...
@interface StuProfileSharedViewController ()
...
@implementation StuProfileSharedViewController
...
- (void)showShareActionSheet:(UIView *)view
{
     ...
     **/
    __weak StuProfileSharedViewController *theController = self;
    
    //1、创建分享参数（必要）
    NSMutableDictionary *shareParams = [NSMutableDictionary dictionary];
    NSArray* imageArray = @[[UIImage imageNamed:@"logogo.png"]];
    [shareParams SSDKSetupShareParamsByText:[NSString stringWithFormat: @"大学生的兼职利器包办、预支随你挑!邀请码为：%@", globalUserName]
                                     images:imageArray
                                        url:[NSURL URLWithString:@"http://115.28.17.160:8081/weChat/"]
                                        title:@"课余时间"
