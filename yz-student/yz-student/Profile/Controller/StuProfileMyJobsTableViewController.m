//
//  StuProfileMyJobsTableViewController.m
//  yz-student
//
...
@interface StuProfileMyJobsTableViewController ()
...
@implementation StuProfileMyJobsTableViewController
...
- (void)loadNewJobs
{
    ...
    NSArray *arry = [StuHomeLocalJob jobsWithSessionId:globalSessionId CurrentPage:[NSString stringWithFormat:@"%d", self.currentPage] PageSize:[NSString stringWithFormat:@"%d", pageSize]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    StuProfileMyJobsDetailTableViewController *vc = [[StuProfileMyJobsDetailTableViewController alloc]init];
