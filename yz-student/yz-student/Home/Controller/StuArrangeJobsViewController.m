...
@interface StuArrangeJobsViewController ()<UITableViewDataSource, UITableViewDelegate, SelectBarProtocol>
...
@implementation StuArrangeJobsViewController
...
- (void)loadNewJobs
{
    ...
    [self.jobsArry addObjectsFromArray: [StuHomeLocalJob jobsWithCityId:globalCityId  AreaId:areaId TypeId:typeId CurrentPage:[NSString stringWithFormat:@"%d", self.currentPage] PageSize:[NSString stringWithFormat:@"%d", pageSize] Period:period Lng:nil Lat:nil Radius:nil Cond:@"isAgent" Value:@"1" JobStatus:@"ongoing"]];
